...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password1'].help_text = '<ul class = "form-text text-muted small"><li>Your Password can\'t be too similar to your other personal information</li><li>Your Password must contain at least 8 characters</li><li>Your Password can\'t be a commonly used password.</li><li>Your Passsword can\'t be entirely numeric</li></ul>'
